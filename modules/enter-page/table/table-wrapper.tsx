...
export function TableWrapper() {
  ...
  const { data, isLoading, error } = useQuery<TProduct[]>({
    queryKey: [tanstackKey, sortField, sortOrder],
    queryFn: async () => {
              ...
              <Dialog key={product.id}>
                <DialogTrigger asChild>
                  ...
                  >
                    ...
                    <TableCell className="px-4 py-3 align-middle">{product.name}</TableCell>
                    <TableCell className="px-4 py-3 align-middle">{product.count}</TableCell>

                    <TableCell className="px-4 py-3 align-middle">
                      {product.size.width}×{product.size.height}
                    </TableCell>

                    <TableCell className="px-4 py-3 align-middle">{product.weight}</TableCell>
